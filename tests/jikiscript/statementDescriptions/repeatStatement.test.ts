...
test("no times", () => {
  ...
  assertHTML(actual, `<p>The repeat block was asked to run<code>0</code>times so this line did nothing.</p>`, [
...
test("one time", () => {
  ...
  `);
  const actual = describeFrame(frames[0], descContext);
  assertHTML(actual, `<p>This line started the 1st iteration of this repeat block.</p>`, [
