...
import { describeFrame, DescriptionContext } from "@jikiscript/frames";
import {
  getNameFunction,
  assertHTML,
...
test("args, description, return", () => {
  ...
  const actual = describeFrame(frames[0], descContext);
  assertHTML(actual, `<p>This used the<code>get_name</code> function with the inputs <code>1</code>.</p>`, [
...
test("args, description, no return", () => {
  ...
  const actual = describeFrame(frames[0], descContext);
  assertHTML(actual, `<p>This used the<code>meh</code> function with the inputs <code>1</code>.</p>`, [
