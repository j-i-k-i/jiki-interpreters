...
test("naked", () => {
  ...
  assertHTML(actual, `<p>This ended the function. No further code was run in the function.</p>`, [
...
test("with literal", () => {
  ...
  assertHTML(
    ...
    [`<li>Jiki put <code>5</code> in the return chute.</li>`, `<li>Jiki cleared up and left the function.</li>`]
  );
});
