...
describe("binary", () => {
  ...
  describe("nesting", () => {
    test("numbers", () => {
      ...
      const binaryExprLeftRightRight = binaryExprLeftRight.right as LiteralExpression;
      expect(binaryExprLeftRightRight.value).toBe(4);

      const binaryExprLeftRightLeft = binaryExprLeftRight.left as BinaryExpression;
      ...
      const binaryExprLeftRightLeftLeft = binaryExprLeftRightLeft.left as LiteralExpression;
      expect(binaryExprLeftRightLeftLeft.value).toBe(2);
      const binaryExprLeftRightLeftRight = binaryExprLeftRightLeft.right as LiteralExpression;
...
describe("if", () => {
  ...
  test("nested", () => {
    ...
    expect(elseIfStmtThenBlock.statements[0]).toBeInstanceOf(SetVariableStatement);
    ...
    expect(elseIfStmtElseBlock.statements[0]).toBeInstanceOf(SetVariableStatement);
  });
});
