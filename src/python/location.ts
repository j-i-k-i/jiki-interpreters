...
export class Location {
  ...
  public static fromLineOffset(begin: number, end: number, line: number, lineOffset: number): Location {
  ...
  public static readonly unknown = new Location(1, { begin: 1, end: 1 }, { begin: 1, end: 1 });
}
